...
- `Lint and Code Quality` - Code formatting, linting, type checking, and config/YAML validation
- `Test Python 3.12` - Tests on Python 3.12 with 95% coverage enforcement
